...
public class GPQService extends AbstractQuotationService implements QuotationService {
	...
	/**
	 * Quote generation: 50% discount for being female 20% discount for no penalty
	 * points 15% discount for < 3 penalty points no discount for 3-5 penalty points
	 * 100% penalty for > 5 penalty points 5% discount per year no claims
	 */
	@Override
