...
int main(void)
{
  ...
  printf("------------------------------------------------------------------\n");
  printf("Demonstration that 0.1 is not presented exactly in floating point.\n");


  printf("x1 is set to 0.3\n");
  printf("x2 is set to 0.1+0.1+0.1\n");
  if (x1equaltox2)
    printf("The computer believes that 0.3=0.1+0.1+0.1 is true\n");
  else
    printf("The computer believes that 0.3=0.1+0.1+0.1 is false\n");
  printf("In fact, 0.1+0.1+0.1=%.20f\n", x2);
  printf("0.3 - (0.1+0.1+0.1)= %.20f\n", x1-x2);
